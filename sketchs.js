...
if (xBolinha raio < xRaquete + raqueteComprimento && yBolinha yRaquete + raqueteAltura && yBolinha +
 raio > yRaquete) {
...
if (xBolinha < 10) { pontos DoOponente += 1; ponto.play();
...
ponto = loadSound("ponto.mp3"); raquetada =
